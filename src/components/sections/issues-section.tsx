...
// REMOVE Button and ArrowRight imports if no longer needed elsewhere in the file
// import { Button } from "@/components/ui/button";
// import { ArrowRight } from "lucide-react";
// import { Link } from "react-router-dom"; // Remove Link if not needed elsewhere
...
const issues = [
  ...
  },
  {
    ...
    image: "https://i.ibb.co/PZtvsHmf/image.png",
  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
            ...
            <motion.div key={issue.id} variants={itemVariants}>
              <TiltCard className="h-full">
                <div className="relative h-full rounded-xl overflow-hidden border border-border group">
                  ...
                  {/* Remove the duplicate overlay div */}
                  {/* <div className="absolute inset-0 bg-gradient-to-b from-background/60 to-background/90 z-10"></div> */}
        ...
        {/* Keep the section below if you want a general button, otherwise remove it too */}
        {/* <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
