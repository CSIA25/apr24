...
import { Calendar as CalendarIcon, Clock, MapPin, Users, Check, Loader2, AlertCircle, Package, Utensils, Phone } from "lucide-react"; // Added Phone
...
interface FoodDonation {
    ...
    volunteerPhoneNumber?: string; // Added
}
...
const VolunteerPage = () => {
    ...
    const [pickupPhoneNumber, setPickupPhoneNumber] = useState(""); // State for phone number
    ...
    const handleClaimFood = async (donationId: string, notes: string, phoneNumber: string) => {
        console.log("Attempting claim food:", { donationId, userId: user?.uid, notes, phoneNumber });
        ...
        try {
            ...
            const updatePayload = {
                ...
                volunteerPhoneNumber: phoneNumber, // Add phone number
            };
            ...
            setPickupPhoneNumber(""); // Reset phone number after successful claim
                ...
                <section className="py-12 md:py-16">
                    <div className="container mx-auto px-4">
                        ...
                        <motion.div
                            ...
                            className="mb-16" id="food-donations"
                        >
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                                ...
                                {!loadingFood && foodDonations.length === 0 && !error && (
                                    ...
                                    <TiltCard key={donation.id} className="h-full">
                                        ...
                                        >
                                            ...
                                            <div className="p-4 pt-0">
                                                <Dialog onOpenChange={(open) => { if (!open) { setPickupNotes(""); setPickupPhoneNumber(""); }}}> {/* Reset notes and phone when dialog closes */}
                                                    ...
                                                    <DialogContent>
                                                        ...
                                                        <div className="py-4">
                                                            <div className="space-y-2 mb-4">
                                                                <Label htmlFor={`phone-${donation.id}`}>Your Phone Number *</Label>
                                                                <Input
                                                                    id={`phone-${donation.id}`}
                                                                    type="tel"
                                                            ...
                                                            <div className="space-y-2">
                                                                <Label htmlFor={`notes-${donation.id}`}>Pickup Notes *</Label>
                                                                <Textarea
                                                        ...
                                                        <DialogFooter>
                                                            ...
                                                            <Button
                                                                type="button"
                                                                onClick={() => handleClaimFood(donation.id, pickupNotes, pickupPhoneNumber)}
                                                                disabled={claimingFoodId === donation.id || !pickupNotes.trim() || !pickupPhoneNumber.trim()} // Disable if no notes/phone or loading
                        ...
                        {/* Volunteer Opportunities Grid (keep as is) */}
                         <motion.div
                            ...
                            className="mt-12" id="volunteer-events"
                        >
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                                ...
                                {!loadingOpps && opportunities.length === 0 && !error && (
