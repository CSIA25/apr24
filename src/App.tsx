                    ...
                    <BrowserRouter>
                        <AnimatePresence mode="wait">
                            <Routes>
                                ...
                                <Route path="/contact" element={<Contact />} /> {/* Ensure Contact route points to the Contact component */}
                                ...
                                {/* Static/Info Routes (Keep as is - Note: Some are still pointing to NotFound) */}
                                {/* If you implement these pages later, update the element prop */}
